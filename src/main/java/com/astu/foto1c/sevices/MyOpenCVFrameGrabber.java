 ...
 */
public class MyOpenCVFrameGrabber extends FrameGrabber {
    public static String[] getDeviceDescriptions() throws Exception {
        tryLoad();
        throw new UnsupportedOperationException("Device enumeration not support by OpenCV.");
    }

    public static org.bytedeco.javacv.OpenCVFrameGrabber createDefault(File deviceFile)   throws Exception { return new org.bytedeco.javacv.OpenCVFrameGrabber(deviceFile); }
    public static org.bytedeco.javacv.OpenCVFrameGrabber createDefault(String devicePath) throws Exception { return new org.bytedeco.javacv.OpenCVFrameGrabber(devicePath); }
    public static org.bytedeco.javacv.OpenCVFrameGrabber createDefault(int deviceNumber)  throws Exception { return new org.bytedeco.javacv.OpenCVFrameGrabber(deviceNumber); }
    ...
    public static void tryLoad() throws Exception {
        if (loadingException != null) {
            ...
            try {
                ...
                throw loadingException = new Exception("Failed to load " + org.bytedeco.javacv.OpenCVFrameGrabber.class, t);
            }
        }
    }

    public MyOpenCVFrameGrabber(int deviceNumber) {
        this.deviceNumber = deviceNumber;
    }
    public MyOpenCVFrameGrabber(File file) {
        this(file.getAbsolutePath());
    }
    public MyOpenCVFrameGrabber(File file, int apiPreference) {
        this(file.getAbsolutePath(), apiPreference);
    }
    public MyOpenCVFrameGrabber(String filename) {
        this.filename = filename;
    }
    public MyOpenCVFrameGrabber(String filename, int apiPreference) {
        this.filename = filename;
        this.apiPreference = apiPreference;
    }

    public MyOpenCVFrameGrabber(int deviceNumber, int apiPreference) {
        this.deviceNumber = deviceNumber;
        this.apiPreference = apiPreference;
    }
    ...
    public void start() throws Exception {
        if (filename != null && filename.length() > 0) {
            ...
            if (apiPreference > 0) {
                capture = new VideoCapture(deviceNumber, apiPreference);
            } else {
